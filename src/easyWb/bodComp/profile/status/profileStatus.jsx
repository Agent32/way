...
const textForm = () => 
{
    return <input  ref={areaNewPost} onChange= {() =>this.props.editQuote(areaNewPost.current.value) }  autoFocus={true} value= {this.props.quote} onBlur={() => {
    ...
    <div className={profileStyle.main} > { this.state.showForm && this.props.isLoadinFinished ?  textForm() : textFunk() }</div>
